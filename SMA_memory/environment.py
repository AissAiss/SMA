...
class Environment: 
    def __init__(self, file, canvas):
        ...
        self.memory = np.zeros(self.env.shape)
        ...
        self.canvas = canvas
        self.canvas.config(width=self.env.shape[0]*2, height=self.env.shape[1])
        
        #print(self.env.shape) (435, 600)
    ...
    def memoriserPosition(self, x, y): 
        self.memory[x][y] = 1